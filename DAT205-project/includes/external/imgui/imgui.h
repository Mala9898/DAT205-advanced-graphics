...
struct ImDrawList
{
    ...
    ImVector<ImDrawVert>    VtxBuffer;          // VertexStruct buffer.
...
struct ImFontGlyph
{
    ...
    float           U0, V0, U1, V1;     // TextureStruct coordinates
};
...
struct ImFontAtlas
{
    ...
    int                         TexDesiredWidth;    // TextureStruct width desired by user before Build(). Must be a power-of-two. If have many glyphs your graphics API have texture size restrictions you may want to increase texture width to decrease height.
    ...
    int                         TexWidth;           // TextureStruct width calculated during Build().
    int                         TexHeight;          // TextureStruct height calculated during Build().
    ImVec2                      TexUvScale;         // = (1.0f/TexWidth, 1.0f/TexHeight)
    ImVec2                      TexUvWhitePixel;    // TextureStruct coordinates to a white pixel
